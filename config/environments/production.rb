...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "miamisburg_sports_production"
  ...
  config.action_mailer.default_url_options = { host: "www.myschoolsports.us" }
  ...
  mailertogo_domain   = ENV.fetch("MAILERTOGO_DOMAIN", "myschoolsports.us")
